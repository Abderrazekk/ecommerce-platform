...
const Footer = () => {
  ...
  const supportLinks = [
    ...
    { name: "Delivery & Payment", path: "/delivery-payment" },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-400 text-base leading-relaxed">
                  ...
                  premium shopping redefined. Discover the finest collection of 
                  products with exceptional quality and customer service.
                </p>
