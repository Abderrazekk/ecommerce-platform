          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Curated excellence delivered to your doorstep. Experience premium shopping redefined.
              </p>
              ...
              <div className="flex space-x-3 pt-2">
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-gray-800/50 border border-gray-700/50 flex items-center justify-center text-gray-300 hover:text-[#1877F2] hover:border-[#1877F2]/50 hover:bg-[#1877F2]/10 transition-all duration-300"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-gray-800/50 border border-gray-700/50 flex items-center justify-center text-gray-300 hover:text-[#E4405F] hover:border-[#E4405F]/50 hover:bg-[#E4405F]/10 transition-all duration-300"
                ...
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-gray-800/50 border border-gray-700/50 flex items-center justify-center text-gray-300 hover:text-[#000000] hover:border-[#000000]/50 hover:bg-[#000000]/10 transition-all duration-300"
                  aria-label="TikTok"
                >
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {['Home', 'Shop All', 'New Arrivals', 'Best Sellers'].map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-gray-400 hover:text-white transition-colors duration-200 group flex items-center text-sm"
                    >
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {['Electronics', 'Fashion', 'Home', 'Lifestyle'].map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-gray-400 hover:text-white transition-colors duration-200 group flex items-center text-sm"
