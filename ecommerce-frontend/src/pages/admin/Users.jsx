...
const UsersPage = () => {
  ...
  const confirmDeleteUser = async () => {
    ...
    try {
      const response = await authService.deleteUser(selectedUser._id);
      toast.success(response.data.message);
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 space-y-4 lg:space-y-0">
          <div>
            ...
            <p className="text-gray-600">
              Manage users, search, filter, and create admin accounts
            </p>
          </div>
          <button
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {banFilter !== "all" && (
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-purple-100 text-purple-800">
                Filter:{" "}
                {banFilter === "banned" ? "Banned Users" : "Active Users"}
                <button
                  onClick={() => setBanFilter("all")}
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-yellow-800">
                          Banning User: {selectedUser.name}
                        </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                      Provide a clear and specific reason for the ban. This will
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <ul className="text-xs text-gray-600 space-y-1">
                      ...
                      <li className="flex items-start">
                        ...
                        <span>
                          Ban reason will be displayed on their profile
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t">
                  ...
                  <button
                    ...
                    disabled={
                      !banReason.trim() || banningUserId === selectedUser._id
                    }
                ...
                <div className="mb-6">
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-red-700 mt-1">
                          You are about to permanently delete a user account.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex">
                        <span className="w-20 text-gray-600">Role:</span>
                        <span
                      ...
                      <div className="flex">
                        <span className="w-20 text-gray-600">Joined:</span>
                        <span>
                          {new Date(
                  ...
                  <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-yellow-700 space-y-1">
                      <li className="flex items-start">
                        <div className="h-1.5 w-1.5 bg-yellow-600 rounded-full mt-1.5 mr-2"></div>
                        <span>User account and all personal information</span>
                      </li>
                      <li className="flex items-start">
                        <div className="h-1.5 w-1.5 bg-yellow-600 rounded-full mt-1.5 mr-2"></div>
                        <span>
                          User's order history (optional: you may keep orders
                          for records)
                        </span>
                      </li>
                      <li className="flex items-start">
                        <div className="h-1.5 w-1.5 bg-yellow-600 rounded-full mt-1.5 mr-2"></div>
                        <span>User's wishlist and saved items</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  {selectedUser._id === currentUser?._id && (
                    <div className="mt-4 p-3 bg-red-100 border border-red-300 rounded-lg">
                      <p className="text-sm text-red-700 font-medium">
                        ⚠️ You cannot delete your own account while logged in.
                      </p>
                    </div>
                  )}
                </div>
