      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <a
              href="mailto:support@shopina.com"
              className="text-primary-600 hover:text-primary-800 font-medium text-lg transition-colors"
            >
              support@shopina.com
            </a>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-500 text-sm mt-2">
              Service gratuit depuis la France
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Sous 24 heures maximum par email
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm">
        ...
        <div className="text-center">
          <p className="text-gray-600 mb-8">
            Notre équipe dédiée est à votre écoute pour toute question
            concernant vos commandes, les retours, les garanties ou tout autre
            sujet lié à votre expérience d'achat.
          </p>
